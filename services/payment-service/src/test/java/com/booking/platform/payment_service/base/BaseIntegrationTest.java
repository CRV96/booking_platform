package com.booking.platform.payment_service.base;
...
/**
 * Base class for all payment-service integration tests.
 *
 ...
 *
 * <p>Flyway runs automatically on context startup and applies
 * V1__create_payments_table.sql and V2__create_outbox_events_table.sql
...
public abstract class BaseIntegrationTest {
    ...
    static void containerProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.kafka.consumer.group-id", () -> "payment-service-test-group");
